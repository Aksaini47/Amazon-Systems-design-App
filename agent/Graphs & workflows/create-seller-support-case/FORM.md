...
**What steps have you taken already?** (one line only)
```
I built the test app, finished partner signup step 2, and live registration still will not open.
```

**Subject:** `need live seller tools`
...
**Subject:** `developer profile approval`
...
**Subject:** `mahika live access india`
...
**Subject:** `help with live app`

---

## After IP2

Continue → ignore suggestion → chip **Other account issues** → subject → **Email** tab → phone `7015436711` → **Send**.
